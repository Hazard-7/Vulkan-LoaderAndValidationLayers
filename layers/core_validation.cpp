...
static void PostCallValidateAllocateMemory(layer_data *dev_data, const VkMemoryAllocateInfo *pAllocateInfo,
...
VKAPI_ATTR VkResult VKAPI_CALL AllocateMemory(VkDevice device, const VkMemoryAllocateInfo *pAllocateInfo,
    ...
    if (!skip) {
        ...
        lock.lock();
        PostCallValidateAllocateMemory(dev_data, pAllocateInfo, pMemory);
    }
    return result;
}
